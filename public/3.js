            ...
            [
              ...
              _vm.statusCode === 404
                ? _c(
                    ...
                    {
                      staticClass:
                        "sm:mx-0 mx-4 mb-4 sm:mb-16 d-theme-text-inverse"
                    },
                    [
                      _vm._v(
                        "\n                    " +
                          _vm._s(
                            _vm.__("Seems this page went missing, sorry.")
                          ) +
                          "\n                 "
                      )
                    ]
                    ...
                    [
                      _vm._v(
                        "\n                    " +
                          _vm._s(
                            _vm.__(
                              "It seems you are not authorized to make this request. Our developers have been notified."
                            )
                          ) +
                          "\n                "
                      )
                ...
                ? _c(
                    ...
                    [
                      _vm._v(
                        "\n                    " +
                          _vm._s(
                            _vm.__("It seems you have no access to this page.")
                          ) +
                          "\n                "
                      )
                    ]
