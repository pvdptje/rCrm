...
<head>
    ...
    <title>rCrm</title>
    <meta name="description" content="Maak tijd vrij voor wat echt belangrijk is. Doe het met rCrm.">
                    ...
                    <ul class="navbar-nav border-left flex-row ">
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link  dropdown-toggle text-nowrap px-3" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                <img class="user-avatar rounded-circle mr-2 logo-avatar avatar-img" src="{{ $companyLogo ? asset($companyLogo) : '/images/logos/logo_square.png' }}" alt="{{ __('Company logo') }}">
