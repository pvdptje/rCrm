...
@section('content')
    ...
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
            <span class="text-uppercase page-subtitle">{{ _('Create a new appointment') }}</span>
            <h3 class="page-title">{{ __('Create Appointment') }}</h3>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h6 class="mb-0">{{ __('New appointment') }}</h6>
                </div>
                <div class="card-body">
